...
<div id="mainNavigation" class={isSticky ? "sticky" : "static"}>
  ...
  <div class="navbar-expand-md  justify-content-center ">
    <div class="navbar-dark text-center my-2">
      ...
      >
        <span class="align-middle" id="navbar-toggler">Menu</span>
      </button>
    </div>
    <div
